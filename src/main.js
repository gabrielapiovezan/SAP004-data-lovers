...
const main = () => {
    clearDisplay()
    const elementMain = pokemons.filter((pokemons) => pokemons.id < 8)
...
document.getElementById("select-pokemons").addEventListener('input', calculator)
functionMenu()
main()
selectPokemons()
    //calculator()
